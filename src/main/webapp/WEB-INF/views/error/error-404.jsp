...
<head>
    ...
    <link rel="shortcut icon"
          href="${ctx}/assets/img/favicon.png"
          type="image/x-icon">
    ...
    <link href="${ctx}/assets/css/font-awesome.min.css"
          rel="stylesheet"/>
    <link href="${ctx}/assets/css/weather-icons.min.css"
          rel="stylesheet"/>

    <!--Beyond styles-->
    <link href="${ctx}/assets/css/beyond.min.css"
          rel="stylesheet"/>
    <link href="${ctx}/assets/css/demo.min.css"
          rel="stylesheet"/>
