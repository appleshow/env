...
<script type="application/javascript">
    ...
    var tableG = '<!--#tbReport-->\n' +
        ...
        '                    <tr>\n' +
        '                        <th colspan="16"\n' +
        '                            style="text-align: center;"><h3><b>表 D-10 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;烟气排放连续监测小时平均值日报表</b>\n' +
        '                        </h3>\n' +
        '                        </th>\n' +
        '                    </tr>\n' +
        '                    <tr>\n' +
        ...
        '                            排放源编号：<span id="nodeMN"></span><span style="padding-left: 40%;">监测日期：<span\n' +
        '                                id="reportYear"></span>年 <span id="reportMonth"></span>月 <span\n' +
        '                                id="reportDay"></span>日</span>\n' +
        '                        </th>\n' +
        '                    </tr>\n' +
        '                    <tr>\n' +
        '                        <th rowspan="2"\n' +
    ...
    var tableW = '<!--#tbReport-->\n' +
        ...
        '                    <tr>\n' +
        '                        <th colspan="7"\n' +
        '                            style="text-align: center;"><h3><b>表 D-10 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;污水排放连续监测小时平均值日报表</b>\n' +
        '                        </h3>\n' +
        '                        </th>\n' +
        '                    </tr>\n' +
        '                    <tr>\n' +
    ...
    var tableD = '<!--#tbReport-->\n' +
        ...
        '                    <tr>\n' +
        '                        <th colspan="7"\n' +
        '                            style="text-align: center;"><h3><b>表 D-10 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;大气质量连续监测小时平均值日报表</b>\n' +
        '                        </h3>\n' +
        '                        </th>\n' +
        '                    </tr>\n' +
        '                    <tr>\n' +
