        ...
        <div class="panel panel-default"
            ...
            <div class="panel-body"
                ...
                <table class="table table-striped table-bordered display responsive nowrap"
                    ...
                    <tr>
                        <th colspan="16"
                            style="text-align: center;"><h3><b>表 D-11 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;烟气排放连续监测日平均值月报表</b></h3>
                        </th>
                    </tr>
                    <tr>
                        <th colspan="16"
...
<script type="application/javascript">
    ...
    function refData() {
        ...
        pagePars.columnHeadInfo = [
            ["表 D-11            烟气排放连续监测日平均值月报表"],
            ["排放源名称：" + pagePars.selectNodeName],
            ["排放源编号：" + pagePars.selectNodeMN + "                                           监测月份：" + selectDateSplit[0] + " 年 " + selectDateSplit[1] + " 月"],
