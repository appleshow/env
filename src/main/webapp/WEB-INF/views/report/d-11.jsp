...
<script type="application/javascript">
    ...
    var tableG = '<!--#tbReport-->\n' +
        ...
        '                    <tr>\n' +
        '                        <th colspan="16"\n' +
        '                            style="text-align: center;"><h3><b>表 D-11 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;烟气排放连续监测日平均值月报表</b>\n' +
        '                        </h3>\n' +
        '                        </th>\n' +
        '                    </tr>\n' +
        '                    <tr>\n' +
        ...
        '                            排放源编号：<span id="nodeMN"></span><span style="padding-left: 40%;">监测月份：<span id="reportYear"></span>年 <span id="reportMonth"></span>月</span>\n' +
        '                        </th>\n' +
        '                    </tr>\n' +
        '                    <tr>\n' +
        '                        <th rowspan="2"\n' +
    ...
    var tableW = '<!--#tbReport-->\n' +
        ...
        '                    <tr>\n' +
        '                        <th colspan="7"\n' +
        '                            style="text-align: center;"><h3><b>表 D-11 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;污水排放连续监测日平均值月报表</b>\n' +
        '                        </h3>\n' +
        '                        </th>\n' +
        '                    </tr>\n' +
        '                    <tr>\n' +
    ...
    var tableD = '<!--#tbReport-->\n' +
        ...
        '                    <tr>\n' +
        '                        <th colspan="7"\n' +
        '                            style="text-align: center;"><h3><b>表 D-11 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;大气质量连续监测日平均值月报表</b>\n' +
        '                        </h3>\n' +
        '                        </th>\n' +
        '                    </tr>\n' +
        '                    <tr>\n' +
    ...
    function dataTableAjax(data, callback, settings) {
        ...
        if (pagePars.selectNodeId == "") {
            ...
            var selectDate = $("#dateStr").val() + "-01";
            var selectDateSplit = selectDate.split("-");
            var year = parseInt(selectDateSplit[0]);
            var month = parseInt(selectDateSplit[1]);
            var selectDateObject = new Date(year, month, 1);
            var dateStr = selectDate + " 00:00:01";
            var dateEnd = selectDateObject.format("yyyy-MM-dd") + " 00:00:01";
            var dataRows = parseInt((new Date(selectDateObject.getFullYear(), selectDateObject.getMonth(), 0)).format("dd"));
    ...
    function refData(loadData) {
        ...
        $("#reportMonth").html(selectDateSplit[1]);
