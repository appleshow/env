...
public class ComRegion {
    ...
    public String getFarRegionId() {
        return farRegionId;
    }

    public void setFarRegionId(String farRegionId) {
        this.farRegionId = farRegionId == null ? null : farRegionId.trim();
    }
