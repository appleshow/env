...
<script>
    ...
    // 初始化 Grid
    function pageIni() {
        var url = "${ctx}/viewOrgFormConfig/referCombCode";
        ...
        $("#treeOrgA").tree({
            ...
            onCheck: function (node, checked) {
                ...
                if (checked) {
                    ...
                    var url = "${ctx}/viewOrgFormConfig/referOrgForm";
                    var inf = {
                        parCount: 1,
                        inPar: {
                            orgId: nodeid
            ...
            onCheck: function (node, checked) {
                ...
                if (checked) {
                    ...
                    if (findformid != -1) {
                        ...
                        // 查询窗体权限信息
                        var url = "${ctx}/viewOrgFormConfig/referFormRights";
                        var inf = {
                            parCount: 1,
                            inPar: {
                                formId: formid
                                ...
                                if (res.code != 0) {
                                    ...
                                    for (var icnt = 0; icnt < res.data.length; icnt++) {
                                        ...
                                        roworgform = {
                                            ...
                                            codeName: findComCodeName("1", res.data[icnt].prtype),
        ...
        dgOrgPageA.dbinf.modify = {
            url: "${ctx}/viewOrgFormConfig/modifyOrgForm",
        };
        ...
        dgOrgPageA.Grid.datagrid({
            ...
            onCheck: function (index, row, check) {
                ...
                if (!insert) {
                    ...
                    // ******
                    var url = "${ctx}/viewOrgFormConfig/referOrgFormRights";
                    var inf = {
                        parCount: 1,
                        inPar: {
                            formId: row.formId,
                            ...
                            if (res.code != 0) {
                                ...
                                for (var icnt = 0; icnt < res.data.length; icnt++) {
                                    roworgform = {
                                        ...
                                        codeName: findComCodeName("1", res.data[icnt].comFormRights.prtype),
                                        rea: res.data[icnt].rea,
        ...
        dgPageCtlA.dbinf.modify = {
            url: "${ctx}/viewOrgFormConfig/modifyOrgFormRights",
        };
    ...
    function toolRef() {
        ...
        var url = "${ctx}/viewOrgFormConfig/referOrg";
        var inf = {};
        // 加载组织Tree
        $.ajax({
            async: false,
        ...
        url = "${ctx}/viewOrgFormConfig/referForm";
        // 加载窗体Tree
        $.ajax({
            async: false,
            type: "POST",
     ...
     * @returns
     */
    function findComCodeName(codeType, codeId) {

        for (var index = 0; index < comCode.length; index++) {
            if (comCode[index].codeType == codeType && comCode[index].codeId == codeId) {
