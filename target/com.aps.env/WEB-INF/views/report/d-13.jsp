...
<script type="application/javascript">
    ...
    var tableG = '<!--#tbReport-->\n' +
        ...
        '                    <tr>\n' +
        '                        <th colspan="16"\n' +
        '                            style="text-align: center;"><h3><b>表 D-13 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;烟气排放连续监测月平均值年报表</b>\n' +
        '                        </h3>\n' +
        '                        </th>\n' +
        '                    </tr>\n' +
        '                    <tr>\n' +
    ...
    var tableW = '<!--#tbReport-->\n' +
        ...
        '                    <tr>\n' +
        '                        <th colspan="7"\n' +
        '                            style="text-align: center;"><h3><b>表 D-13 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;污水排放连续监测月平均值年报表</b>\n' +
        '                        </h3>\n' +
        '                        </th>\n' +
        '                    </tr>\n' +
        '                    <tr>\n' +
    ...
    var tableD = '<!--#tbReport-->\n' +
        ...
        '                    <tr>\n' +
        '                        <th colspan="7"\n' +
        '                            style="text-align: center;"><h3><b>表 D-13 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;大气质量连续监测月平均值年报表</b>\n' +
        '                        </h3>\n' +
        '                        </th>\n' +
        '                    </tr>\n' +
        '                    <tr>\n' +
    ...
    function dataTableAjax(data, callback, settings) {
        ...
        if (pagePars.selectNodeId == "") {
            ...
            var dateStr = year + "-01-01 00:00:01";
            var dateEnd = (year + 1) + "-01-01 00:00:01";
