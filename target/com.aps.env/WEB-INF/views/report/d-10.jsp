                ...
                <table class="table table-striped table-bordered display responsive nowrap"
                    ...
                    <tr>
                        <th colspan="16"
                            ...
                            排放源编号：<span id="nodeMN"></span><span style="padding-left: 40%;">监测日期：<span id="reportYear"></span>年 <span id="reportMonth"></span>月 <span id="reportDay"></span>日</span>
                        </th>
                    </tr>
                    <tr>
                        <th rowspan="2"
...
<script type="application/javascript">
    ...
    function dataTableAjax(data, callback, settings) {
        ...
        if (pagePars.selectNodeId == "") {
            ...
            var selectDate = $("#dateStr").val();
            var selectDateObject = new Date(selectDate);

            selectDateObject.setDate(selectDateObject.getDate() + 1);
    ...
    function refData() {
        ...
        $("#reportDay").html(selectDateSplit[2]);

        pagePars.columnHeadInfo = [
            ["表 D-10            烟气排放连续监测小时平均值日报表"],
            ["排放源名称：" + pagePars.selectNodeName],
            ["排放源编号：" + pagePars.selectNodeMN + "                                           监测日期：" + selectDateSplit[0] + " 年 " + selectDateSplit[1] + " 月 " + selectDateSplit[2] + " 日"],
            ["时间", "颗粒物", "", "", "SO2", "", "", "NOx", "", "", "标态流量", "氧量", "烟温", "含湿量", "负荷", "备注"],
            ["", "mg/m3", "折算mg/m3", "kg/h", "mg/m3", "折算mg/m3", "kg/h", "mg/m3", "折算mg/m3", "kg/h", "m3/m", "%", "℃", "%", "%", ""]];
